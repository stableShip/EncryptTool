...
var EncryptTool = (function () {
     ...
     * @returns {*}
     */
    EncryptTool.base64_encode = function (str, encoding) {
     ...
     * @returns {*}
     */
    EncryptTool.base64_decode = function (encodingStr, encoding) {
        if (encoding === void 0) { encoding = "base64"; }
        if (_.isEmpty(encodingStr))
            return "";
     ...
     * @return 加密后字符串.
     */
    EncryptTool.aes_encode = function (data) {
        //使用的加密算法
     ...
     * @return 解密后字符串.
     */
    EncryptTool.aes_decode = function (encodingStr) {
        //使用的算法
        var algorithm = 'AES-128-ECB';
        //使用的密匙
        var key = 'jydasai38hao1616';
     ...
     * @return 加密后的字符串
     */
    EncryptTool.md5Encode = function (data, encoding) {
